...
import tests.common_jsonization"""
    ...
    for our_type in symbol_table.our_types:
        ...
        for descendant in our_type.concrete_descendants:
            load_concrete_complete_name = aas_core_codegen.python.naming.function_name(
                aas_core_codegen.common.Identifier(f"load_complete_{descendant.name}")
            )
...
{I}concrete_instance = (
{II}tests.common_jsonization.{load_concrete_complete_name}()
{I})
...
if __name__ == "__main__":
    ...
    target_pth = repo_root / "tests/test_jsonization_of_classes_with_descendants.py"
